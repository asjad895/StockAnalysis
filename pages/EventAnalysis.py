...
df=pd.read_csv('pages/Parsed_and_Scored.csv')
st.set_page_config(page_title="MarketMoodMeter-EventAnalysis", page_icon="random", layout="wide", initial_sidebar_state="expanded")
